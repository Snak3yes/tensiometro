"""
GerberGeometry - Funções geométricas para geração de polígonos Gerber.

Este módulo contém funções para gerar polígonos que representam
objetos Gerber (círculos, retângulos, ovais).

Copiado de: poc_gerber/gerber_viewer/geometry.py
"""
...
def circle_to_polys_mm(
    ...
    Args:
        ...
        dia_mm: Diâmetro do círculo em mm
        n_sides: Número de lados do polígono (padrão: 64)
...
def rect_to_polys_mm(
    ...
    Args:
        xc: Coordenada X do centro em mm
        yc: Coordenada Y do centro em mm
        w_mm: Largura do retângulo em mm
        h_mm: Altura do retângulo em mm
